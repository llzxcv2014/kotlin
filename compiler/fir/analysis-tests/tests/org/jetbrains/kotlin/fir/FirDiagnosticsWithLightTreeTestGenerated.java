...
public class FirDiagnosticsWithLightTreeTestGenerated extends AbstractFirDiagnosticsWithLightTreeTest {
    ...
    @TestMetadata("compiler/fir/resolve/testData/resolve/localClasses")
    @TestDataPath("$PROJECT_ROOT")
    @RunWith(JUnit3RunnerWithInners.class)
    public static class LocalClasses extends AbstractFirDiagnosticsWithLightTreeTest {
        ...
        public void testAllFilesPresentInLocalClasses() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadataWithExcluded(this.getClass(), new File("compiler/fir/resolve/testData/resolve/localClasses"), Pattern.compile("^([^.]+)\\.kt$"), null, true);
        }

        @TestMetadata("implicitInAnonymous.kt")
        public void testImplicitInAnonymous() throws Exception {
            runTest("compiler/fir/resolve/testData/resolve/localClasses/implicitInAnonymous.kt");
        }

        @TestMetadata("implicitInLocalClasses.kt")
        public void testImplicitInLocalClasses() throws Exception {
            runTest("compiler/fir/resolve/testData/resolve/localClasses/implicitInLocalClasses.kt");
        }
    }
